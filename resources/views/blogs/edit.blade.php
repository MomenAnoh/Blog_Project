    ...
    <form action="{{ route('Blog.update', $edit->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <select class="form-select" name="country" id="validationServer04"  required>
                <option selected disabled value="">{{ $edit->country }}</option>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="city" id="validationServer03"
        ...
        <div class="row">
            <div class="col">
                ...
                <select name="section_id" class="form-control">
                    <option value="{{ $edit->section->id }}" selected>{{ $edit->section->section }}</option>
                    <option disabled>chose section</option>
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" name="blog_title" id="blog_title"
                value="{{ $edit->blog_title }}" required>
            <br>
        </div>
