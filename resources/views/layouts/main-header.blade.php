<!-- main-header opened -->
<div class="main-header sticky side-header nav nav-item" style="background: linear-gradient(to right, #3e2723, #e63946); color: #fff;">
    <div class="container-fluid">
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-header-menu nav nav-item nav-link">
                    <a class="dropdown-item" href="{{ url('/' . $page='auth.login') }}"><i class="bx bx-log-out"></i> Sign Out</a>                    
